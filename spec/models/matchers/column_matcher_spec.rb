...
describe "ColumnMatcher" do
  ...
  describe "in a column of wrong type" do
    ...
    it { should_not have_db_column(:nickname).of_type(:string) }
  end
  ...
  describe "in a column of wrong limit" do
    ...
    it { should_not have_db_column(:email).of_type(:string).with_options(:limit => 255) }
  end
  ...
  describe "in a column of wrong default" do
    ...
    it { should_not have_db_column(:admin).of_type(:boolean).with_options(:default => false) }
  end
  ...
  describe "in a column of correct null" do
    ...
    it { should have_db_column(:admin).of_type(:boolean).with_options(:null => false) }
  end
  ...
  describe "in a column of wrong null" do
    ...
    it { should_not have_db_column(:admin).of_type(:boolean).with_options(:null => false) }
  end
  ...
  describe "in a column of correct scale" do
    ...
    it { should have_db_column(:salary).of_type(:decimal).with_options(:scale => 2) }
  end
  ...
  describe "in a column of wrong scale" do
    ...
    it { should_not have_db_column(:salary).of_type(:decimal).with_options(:scale => 2) }
  end
